...
class filebeat (
  ...
  $config_file_owner                                 = $filebeat::params::config_file_owner,
  $config_file_group                                 = $filebeat::params::config_file_group,
  ...
  $config_dir_owner                                  = $filebeat::params::config_dir_owner,
  $config_dir_group                                  = $filebeat::params::config_dir_group,
  $purge_conf_dir                                             = $filebeat::params::purge_conf_dir,
  $outputs                                                    = $filebeat::params::outputs,
  $queue                                                    = $filebeat::params::queue,
  ...
  $download_url  = undef, # lint:ignore:140chars
  ...
  $disable_config_test                                        = $filebeat::params::disable_config_test,
  $processors                                                 = [],
  $prospectors                                                = {},
  $setup                                                      = {},
  $proxy_address = undef, # lint:ignore:140chars
  $filebeat_path                                 = $filebeat::params::filebeat_path
